    ...
    <div className="bg-bg-secondary rounded-2xl shadow-xl border border-border-default overflow-hidden transition-all hover:shadow-2xl">
      <div className="p-8">
        <div className="text-center mb-10">
          ...
          <h1 className="text-h4 text-text-primary mb-2">Welcome Back!</h1>
          <p className="text-body-s1 text-text-secondary">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="text-right">
              <a
                href="#"
                className="text-caption2 text-brand-purple hover:underline"
              >
                Forget Password ?
              </a>
            </div>
          ...
          <div className="flex flex-col items-center space-y-4 pt-4 border-t border-border-default/50">
            ...
            <div className="flex gap-4">
              ...
              <button
                type="button"
                className="p-2 border border-border-default rounded-full hover:bg-bg-primary transition-colors"
              >
                <svg
              ...
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24">
                  ...
                  <path
                    fill="#34A853"
                    d="M16.04 18.013c-1.09.693-2.414 1.078-4.04 1.078a7.077 7.077 0 0 1-6.723-4.823l-4.04 3.111C3.15 21.28 7.24 24 12 24c3.127 0 5.952-1.036 8.04-2.822l-4-3.165z"
                  />
                  <path
                    fill="#4285F4"
                    d="M23.49 12.275c0-.825-.075-1.62-.213-2.385H12v4.567h6.452a5.54 5.54 0 0 1-2.412 3.556l4 3.165c2.333-2.152 3.45-5.32 3.45-8.903z"
                  />
                  <path
                    fill="#FBBC05"
                    d="M5.286 14.268a7.014 7.014 0 0 1-.377-2.268c0-.795.137-1.558.377-2.268l-4.027-3.115A11.958 11.958 0 0 0 0 12c0 1.892.44 3.684 1.223 5.308l4.063-3.04z"
                  />
                </svg>
              </button>
            </div>
          ...
          {loginMutation.isError && (
            <div className="bg-state-error/10 border border-state-error/20 p-3 rounded-lg flex items-center gap-3 animate-in shake">
              <p className="text-caption2 text-state-error">
        ...
        <p className="mt-8 text-center text-body-s1 text-text-secondary">
          ...
          <a
            href="/register"
            className="text-body-s2 text-brand-purple hover:underline transition-all"
          >
            Sign Up
          </a>
        </p>
