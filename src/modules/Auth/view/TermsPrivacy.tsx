        ...
        <div className="flex-1 overflow-y-auto pr-4">
          ...
          <section className="mb-8">
            ...
            <div className="text-[18px] font-normal leading-6.25 tracking-[0.02em] text-text-primary space-y-1">
              ...
              <p>
                Users must be at least 18 years old or have obtained parental
                consent to use the platform.
              </p>
              <p>
                All information provided by users must be accurate, truthful,
                and current.
              </p>
              <p>
                Users are responsible for maintaining the confidentiality of
                their account credentials and all activities performed under
                their accounts.
              </p>
              <p>
                All events submitted must comply with applicable laws and the
                platform's content guidelines. Events containing inappropriate,
                illegal, or misleading information will be removed.
              </p>
              <p>
                The platform reserves the right to suspend or remove any user or
                content that violates these terms.
              </p>
              <p>
                The website and its services are provided "as is" without
                warranties. The platform is not liable for any damages resulting
                from the use of the site or its content.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-[18px] font-normal leading-6.25 tracking-[0.02em] text-text-primary space-y-1">
              ...
              <p>
                Your personal data will never be sold or rented to third
                parties. It may only be shared with trusted service providers
