...
export default function ForgotPasswordPage() {
    ...
    return (
        <div className="w-full py-2 2xl:py-4">
            <div className="text-center mb-6 2xl:mb-10">
                <h1 className="text-[32px] md:text-[40px] 2xl:text-[48px] font-bold text-brand-purple mb-1">Forgot Password?</h1>
                <p className="text-[14px] 2xl:text-[18px] text-text-secondary">Enter your email to receive reset instructions</p>
            </div>
            ...
            {isSent ? (
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 2xl:space-y-8">
                    {/* Email */}
                    <div className="space-y-2">
                        <label className="text-[13px] 2xl:text-[16px] font-semibold text-text-primary px-1">Email</label>
                        <div className="relative">
                            <Input
                                {...register('email')}
                                type="email"
                                placeholder="placeholder@gmail.com"
                                className={`pl-10 h-10 2xl:h-14 bg-white rounded-xl border transition-all ${errors.email ? 'border-state-error shadow-[0_0_0_1px_rgba(218,57,44,0.1)]' : 'border-border-default focus:border-brand-purple'}`}
                            />
                        ...
                        {errors.email && (
                            <div className="flex items-center gap-1 text-state-error mt-1 px-1">
                                ...
                                <p className="text-[11px] 2xl:text-[12px]">{errors.email.message}</p>
                            </div>
                        )}
                    </div>
                    ...
                    <p className="text-center text-[13px] 2xl:text-[16px] text-text-secondary pt-2 2xl:pt-4">
