...
export default function NotificationPage() {
  ...
  return (
    <div className="flex flex-1 gap-6 px-20 py-4">
      <div className="flex-1 bg-white rounded-2xl p-8 mt-9 ml-9">
          ...
          {dates.map((date) => (
            <div key={date}>
              <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-2">
                ...
                <span className="text-[12px] text-gray-400">24 Dec</span> {/* Static for now or we could add real dates to mock */}
              </div>
